  ...
  return (
    <AppShell>
      ...
      >
          ...
          <div className="px-4 mb-5">
            ...
            >
              ...
              <div className="relative rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
                ...
                {/* Stats row merged into gekioshi card */}
                {statsRow}
              </div>
            </motion.div>
          </div>
        ...
        {/* Tanmou / User Status Section (without stats when gekioshi exists) */}
        {user && (
          <div className="px-4 mb-5">
            <motion.div
            ...
            >
              ...
              {/* Stats row only when no gekioshi card */}
              {!gekioshiCard && statsRow}
            </motion.div>
          </div>
        )}
